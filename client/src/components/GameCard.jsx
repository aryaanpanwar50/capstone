...
const GameCard = ({ game, isNewRelease = false }) => {
  ...
  return isNewRelease ? (
    <div className="min-w-[110px] max-w-[180px] flex-shrink-0 bg-black rounded-xl overflow-hidden transition-all duration-300 cursor-pointer hover:-translate-y-2 hover:shadow-lg hover:shadow-black/20">
