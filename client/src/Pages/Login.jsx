                    ...
                    >
                      ...
                      <div className="space-y-1">
                        <div className="flex justify-between">
                          ...
                          <a
                            href="#"
                            className="text-sm text-[#06c1ff] hover:text-white transition duration-300"
                          >
                            Forgot password?
                          </a>
                        </div>
                    ...
                    <div className="mt-8">
                      ...
                      <div className="mt-4">
                        <button
                          ...
                          className={`w-full inline-flex justify-center items-center py-3 px-4 border border-[#06c1ff]/40 rounded-lg bg-white/5 hover:bg-white/15 hover:border-[#06c1ff]/60 transition-all duration-300 ${
                            isDarkMode ? "text-white" : "text-gray-800"
                          } hover:shadow-md`}
                        >
                          <svg
                            ...
                            className={`h-5 w-5 mr-2 ${
                              isDarkMode ? "text-[#06c1ff]" : "text-gray-600"
                            }`}
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke="currentColor"
                ...
                >
                  ...
                  <div className="max-w-md mx-auto relative z-10">
                    ...
                    <motion.p
                      ...
                      transition={{ delay: 0.5 }}
                    >
                      Create an account and discover the amazing features we
                      offer!
                    </motion.p>
                    <motion.button
